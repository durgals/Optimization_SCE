...
################################################################################
def Goldstein_Price_funct(x, nopt):
    """
    ...
    x2 = x[1]
    u1 = (x1 + x2 + 1.0) ** 2
    u2 = 19.0 - 14.0 * x1 + 3.0 * x1**2 - 14.0 * x2 + 6.0 * x1 * x2 + 3.0 * x2**2
    u3 = (2.0 * x1 - 3.0 * x2) ** 2
    u4 = 18.0 - 32.0 * x1 + 12.0 * x1**2 + 48.0 * x2 - 36.0 * x1 * x2 + 27.0 * x2**2
    u5 = u1 * u2
    u6 = u3 * u4
    f = (1.0 + u5) * (30.0 + u6)
    return f
...
def Sixhump_camelback_funct(x, nopt):
    """3
